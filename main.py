...
def main():
    ...
    with open(filename, 'w', newline='', encoding='utf-8') as csv_file:
        ...
        while True:
            ...
            if firstnum < 9:
                usn_number = usn_num+str("00")+str(firstnum)
                # firstnum ='00'+ firstnum
            elif firstnum<99 and firstnum > 9:
                usn_number = usn_num+str("0")+str(firstnum)
            else:
                usn_number = usn_num+str(firstnum)
                # set rollnumber
            print("USN:",usn_number)
    ...
    for row in data:
        if row:
            ...
            if credit is None:
                ...
                with open("/home/picchai/Documents/GItHub/resluts_automation_ByScrapping/config.json", "w") as config_file:
